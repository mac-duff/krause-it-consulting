...
<html lang="en">         
    <head>
        <meta charset="UTF-8">
        <link rel="canonical" href="http://krause-it-consulting.com/impressum.php"/>
        <link rel="shortcut icon" href="/krauseITC.ico" type="image/x-icon">
        <link rel="icon" href="/kitc.ico" type="image/x-icon">
        <title>Impressum Krause IT Consulting</title>
        <link rel='stylesheet' type='text/css' href='/css/main-01-2014.css' />
    </head>
    <body>
        <header>
            <img src="img/logo-no-font.png" alt="Logo of Krause IT Consulting"/>
            <h1>Impressum (German)</h1>
            <a href="/" title="Homepage of Krause IT Consulting">Home</a>
        </header>
        <div class="bodyDiv">
